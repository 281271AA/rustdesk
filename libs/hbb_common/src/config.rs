...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yy76576525.x3322.net"];
pub const PUBLIC_RS_PUB_KEY: &str = "yjsfux7jooWDFY5L1jeIwBhReeys26UOSG3v+kpDJ70=";
...
pub const RENDEZVOUS_PORT: i32 = 37629;
pub const RELAY_PORT: i32 = 47336;
